...
/* harmony default export */ __webpack_exports__["a"] = (taskController());
...
TaskModel.prototype.done = function (task, status) {
    task.done = status;
    addToLocalStorage(__WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */]);
...
TaskModel.prototype.add = function (text) {
    ...
    console.log(__WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */]);
...
TaskModel.prototype.delete = function (task) {
    ...
    localStorage.setItem('allTasks', JSON.stringify(__WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */]));
    addToLocalStorage(__WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */]);
    this.trigger('delete', [task]);
};

TaskModel.prototype.move = function (task) {
    let index = __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */].indexOf(task);
    if (event.target.innerText === 'Up') {
        if (index !== 0) {
            let tmp = __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index - 1];
            __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index - 1] = task;
            __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index] = tmp;
        }
    } else {
        if (index !== __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */].length - 1) {
            let tmp = __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index + 1];
            __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index + 1] = task;
            __WEBPACK_IMPORTED_MODULE_0__task__["a" /* default */][index] = tmp;
        }
