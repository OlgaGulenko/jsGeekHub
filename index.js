...
// indexOf
var cherkasyoblast = "The oblast extends for 245 km from south-west to north-east, and for 150 km from north to south";

var km = "245 is at position" + cherkasyoblast.indexOf("245");
  km += "150 is at position" + cherkasyoblast.indexOf("150");
  km += "qwerty is at position" + cherkasyoblast.indexOf("qwerty");
console.log(km);
